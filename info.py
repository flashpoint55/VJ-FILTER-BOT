...
PICS = (environ.get('PICS', 'https://envs.sh/_Bd.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/b69af2db776e4e85d21ec.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/How_To_Open_Linkl")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002149281691'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7364818327').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002337599810').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002337599810') # give your force subscribe channel id here else leave it blank
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/gojomoviesgroup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/gojomovie_s')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/gojomovie_s')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'gojomoviesgroup') # Support Chat Link Without https:// or @
